...
public class LambdaQ2 {
    ...
    public static void main(String[] args) {
    	LambdaQ2 a1 = new LambdaQ2(20011,"ACCEPTED");
    	LambdaQ2 a2 = new LambdaQ2(9000,"ACCEPTED");
    	LambdaQ2 a3 = new LambdaQ2(10000,"COMPLETED");
    	LambdaQ2 a4 = new LambdaQ2(101,"ACCEPTED");
    	LambdaQ2 a5 = new LambdaQ2(10005,"ACCEPTED");
        LambdaQ2 a6 = new LambdaQ2(10004,"REJECTED");
        LambdaQ2 a7 = new LambdaQ2(10009,"COMPLETED");
