...
public class StreamQ3 {
    ...
    public static List<String> trader2sFromPuneSortByName(List<Trader> traders) {
        ...
        traders.stream()
                .filter(p-> p.getCity().equals("Hyderabad"))
    ...
    public static void main(String[] args) {
        Trader t1 = new Trader("name1", "Hyderabad");
        Trader t2 = new Trader("name2", "Banglore");
        Trader t3 = new Trader("name3", "Chennai");
        Trader t4 = new Trader("name4", "Pune");
        Trader t5= new Trader("name5", "Hyderabad");

        Trader t6 = new Trader("name6", "Pune");
        Trader t7 = new Trader("name7", "Kerala");
        Trader t8 = new Trader("name8", "Delhi");
        Trader t9 = new Trader("name9", "Hyderabad");
