...
public class StreamQ2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "Arjun", "yaswanth", "comment");
        News news2 =new News(2, "Arjun1", "yaswanth1", "budget");
        News news3 = new News(1, "Arjun2", "yaswanth2", "comment");
        News news4 = new News(3, "Arjun3", "yaswanth", "budget");
        News news5 = new News(1, "Arjun4", "yaswanth2", "comment");
        News news6 = new News(3, "Arjun5", "yaswanth", "budget");
        News news7 = new News(1, "Arjun6", "yaswanth6" ,"comment");
